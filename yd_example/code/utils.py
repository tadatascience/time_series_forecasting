...
def prepare_data(data, year=2021): 
    """
...
def plot_verif(verif, year=2021):
    """
    ...
    ax.axvline(3650*5+365+20, color='0.8', alpha=0.7)
    
    ax.grid(ls=':', lw=0.5)
    
    return f

def plot_verif_component(verif, component='rain', year=2021): 
    """
   ...
   Parameters
    ...
    ax.axvline(3650*5+365+20, color='k', alpha=0.7)
